...
const MATERIALS: Material[] = [
  ...
  },
  {
    ...
    ja: "サテン・シルク",
    dress: 9,
    copy: "最高級素材ゆえの滑らかな肌触りと光沢感を演出し、特殊な素材だからこその“周りとの差別化”になる。",
  },
  {
    label: "WOOL",
    ja: "ウール",
  ...
  },
  {
    ...
    ja: "デニム",
    dress: 4,
    copy: "カジュアルの代表。ただし、黒のストレートで、程よい抜け感へ——7:3 の“3”を担わせるのが、一番おいしい使い方。",
  },
  {
    label: "NYLON",
    ja: "ナイロン",
    dress: 3,
    copy: "スポーツ由来のカジュアル素材。ただし黒のマットなら、無機質な艶が都会的に振れる。テカりと全身使いは、“Uberの配達員”へ。",
  },
  {
    label: "COTTON",
    ja: "コットン",
